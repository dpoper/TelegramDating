...
namespace TelegramDating.DatabaseDataSet1TableAdapters {
...
SELECT Id, Name, Age, Sex, Photo FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TelegramDating.Properties.Settings.Default.DatabaseConnectionString;
        }
